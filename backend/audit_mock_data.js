...
const TARGET_KEYWORDS = [
  'mock', 'dummy', 'sample', 'fake', 'fallback',
  'demo', 'testData', 'mockData', 'sampleData',
  'fixtures', 'hardcoded', 'Math.random'
];
...
console.log(`AUDIT_DONE: ${results.length} matches written to audit_results.json`);
